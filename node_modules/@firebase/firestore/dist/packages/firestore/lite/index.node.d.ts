...
export { Firestore, initializeFirestore, getFirestore, terminate } from './src/api/database';
export { DocumentReference, Query, CollectionReference, collection, doc, parent, getDoc, deleteDoc, setDoc, updateDoc, addDoc } from './src/api/reference';
