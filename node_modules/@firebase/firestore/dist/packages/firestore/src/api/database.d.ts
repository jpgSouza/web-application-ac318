 ...
 */
export declare function changesFromSnapshot<T>(firestore: Firestore, includeMetadataChanges: boolean, snapshot: ViewSnapshot, converter: firestore.FirestoreDataConverter<T> | null): Array<firestore.DocumentChange<T>>;
/**
 ...
 * call.
 */
export declare function applyFirestoreDataConverter<T>(converter: UntypedFirestoreDataConverter<T> | null, value: T, functionName: string): [firestore.DocumentData, string];
